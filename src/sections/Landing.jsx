    ...
    >
      ...
      <div className="relative z-10 text-center w-full px-4 sm:px-6">
        ...
        >
          ...
          <h1
            className="glitch-text text-[4.7rem] sm:text-7xl md:text-9xl lg:text-[12rem] font-display font-black text-upside red-glow tracking-wider leading-none break-words"
